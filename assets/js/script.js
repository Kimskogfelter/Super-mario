document.addEventListener('DOMContentLoaded', () => {
    ...
    function addImageToMemoryCard(card) {
        ...
        // adding character index to card for further use
    ...
    function checkIfCardsMatch(card) {
        if (isProcessingMove || comparingCards) {
            // If the game is still processing a move or comparing cards, return early to ignore additional clicks
            return;
        }
        ...
        if (tempForFlippedCards.length === 2) {
            ...
            if (firstCardId !== secondCardId) {
                setTimeout(() => {
                    ...
                    comparingCards = false; // Allow new card clicks
                }, 1000);
            } else {
